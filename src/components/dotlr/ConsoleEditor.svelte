<script lang="ts">
    ...
    const colors = {
        ...
        warn: 'rgba(var(--warn-rgb), 0.2)',
        info: 'rgba(var(--info-rgb), 0.2)'
    }

</script>


<Card style="padding: 0.5rem; width: 100%;overflow-y: auto;" gap="0.1rem">
    {#each logs as log}
        <div style={`background-color:${colors[log.type]}`} class="log jse-theme-dark">
